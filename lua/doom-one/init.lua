...
doom_one.set_colorscheme = function()
	...
	set_hl("Comment", { fg = dark_theme and palette.base6 or palette.base5, italic = config.ui.italic_comments })
	set_hl("CommentBold", { fg = dark_theme and palette.base6 or palette.base5, bold = true })
